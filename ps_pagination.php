...
class PS_Pagination {
	...
	var $append = "session_id"; //Parameters to append to pagination links
	var $sql = "";
	var $debug = false;
	var $conn = false;
	var $page = 1;
	...
	function PS_Pagination($connection, $sql, $rows_per_page = 6, $links_per_page = 5, $append = "session_id") {
	...
	function renderFirst($tag = 'First') {
		...
		if ($this->page == 1) {
			// CSS Style
			$css_style = "<span style=\"font-family: Verdana; color: #FFFFFF;font-size: 10px; font-weight:bold\">";		
			return $css_style."$tag "."</span>";
